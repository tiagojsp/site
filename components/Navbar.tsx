    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <a href="#" className="text-sm font-medium text-slate-600 hover:text-orange-500 transition-colors">Testimonial</a>
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-100 p-4 space-y-4 shadow-xl">
          ...
          <a href="#" className="block py-2 text-lg font-medium text-slate-900">Features</a>
          <a href="#" className="block py-2 text-lg font-medium text-slate-900">Showcase</a>
          <a href="#" className="block py-2 text-lg font-medium text-slate-900">Testimonial</a>
          <a href="#" className="block py-2 text-lg font-medium text-slate-900">Pricing</a>
          <hr />
          <div className="flex flex-col gap-3 pt-2">
            <button className="w-full py-4 text-center font-bold text-slate-900 border border-slate-200 rounded-xl">Sign In</button>
            <button className="w-full py-4 text-center font-bold bg-orange-500 text-white rounded-xl">Get started</button>
          </div>
        </div>
      )}
    </nav>
